...
#play a song on the music player
def playsong(self):
...
#stop a song on the music player
def stopsong(self):
    # Displaying Status
...
#pause a song on the music player
def pausesong(self):
    # Displaying Status
...
#unpause a song on the music player
...
#main function call to start the music player
